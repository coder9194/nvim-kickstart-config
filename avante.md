...
- If i changed you code, you are not allowed to fall back to your code
...
- You are not allowed to remove my existing type definitions
- You are not allowed to remove my existing codes
- You are not allowed to add your own logic

## 11. Coding Practices and Conventions (Project Specific)
