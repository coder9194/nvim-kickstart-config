return {
  {
    ...
    -- stylua: ignore
    keys = {
      { '<leader>sf', mode = 'n', require('utils.snacks').find_files_in_root, desc = 'Find Files (Root)', },
      { '<leader>sF', mode = 'n', require('utils.snacks').find_files_in_path, desc = 'Find Files (Target)' },
      { '<leader>sg', require('utils.snacks').grep_in_root, desc = 'Grep Files (Root)', },
      { '<leader>sG', require('utils.snacks').grep_in_path, desc = 'Grep Files (Target)', },
      { '<leader>sl', function() Snacks.picker.resume({ source = "lines" }) vim.wait(50) vim.cmd.stopinsert() end, desc = 'Find file lines', },
